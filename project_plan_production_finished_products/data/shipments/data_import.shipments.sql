...
--drop table project_plan_production_finished_products.data_import.shipments
create table project_plan_production_finished_products.data_import.shipments
(

		 shipment_row_id							INT					NOT NULL IDENTITY(1,1)
		,shipment_data_type							VARCHAR(30)			NOT NULL					-- shipments_SAP / shipments_1C / shipments_sales_plan
		...
		,shipment_product_status					VARCHAR(100)			NULL					-- статус блокировки

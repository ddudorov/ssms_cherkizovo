...
(
		...
		,stuffing_data_type						as 'stuffing_fact'
		...
		,CONSTRAINT [UI stuffing_fact | stuffing_sap_id, stuffing_id, stuffing_available_date] UNIQUE(stuffing_sap_id, stuffing_id, stuffing_available_date)

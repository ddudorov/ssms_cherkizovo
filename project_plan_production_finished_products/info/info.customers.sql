...
-- таблица
select * from project_plan_production_finished_products.info.customers
-- drop table project_plan_production_finished_products.info.customers

create table project_plan_production_finished_products.info.customers
(
...
as
	select 
			...
			,'Приоритет отгрузки' = c.shipment_priority		
...
select *
from project_plan_production_finished_products.info_view.customers